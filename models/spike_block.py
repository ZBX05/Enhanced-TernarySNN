...
import math
from models.resnet import BasicBlock, SEWBasicBlock
...
class SpikeBasicBlock(SpikeModule):
    ...
    """
    def __init__(self, basic_block: BasicBlock, step=2, complementary='static', tmpr=False):
        super().__init__()
        self.step = step
        ...
        self.relu1 = LIFAct(step, complementary, tmpr)
        ...
        self.output_act = LIFAct(step, complementary, tmpr)
...
class SpikeSEWBasicBlock(SpikeModule):
    """
    Implementation of Spike BasicBlock used in ResNet-18 and ResNet-34.
    """
    def __init__(self, basic_block: SEWBasicBlock, step=2, complementary='static', tmpr=False, connect_f='ADD'):
        super().__init__()
...
def is_normal_blk(module):
    return isinstance(module, BasicBlock) or isinstance(module, SEWBasicBlock)


def is_spike_blk(module):
    return isinstance(module, SpikeBasicBlock) or isinstance(module, SpikeSEWBasicBlock)


specials = {BasicBlock: SpikeBasicBlock, SEWBasicBlock: SpikeSEWBasicBlock}

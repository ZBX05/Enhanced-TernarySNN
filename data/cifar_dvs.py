...
from torchvision.transforms import RandomResizedCrop, Resize, ToTensor, ToPILImage
import torchvision
...
class DVSCifar10(Dataset):
    def __init__(self, root, train=True, transform=None, target_transform=None):
        ...
        self.train = train
        # self.tensorx = ToTensor()
        # self.imgx = ToPILImage()
        self.resize = Resize(size=(48, 48))
    ...
    def __getitem__(self, index):
        ...
        """
        data, target = torch.load(self.root + '/{}/{}.pt'.format('train' if self.train else 'test', index))
